...
public class DetailActivity extends BaseActivity implements IAlbumDetailViewCallback, UILoader.OnRetrayClickListener, DetailListAdapter.ItemClickListener, IPlayerCallback, ISubscriptionCallback {
